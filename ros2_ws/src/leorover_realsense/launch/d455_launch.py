...
configurable_parameters = [{'name': 'camera_name',                  'default': f'realsense_camera_{robot_namespace}', 'description': 'camera unique name'},
                           # {'name': 'base_frame_id',                'default': '', 'description': 'camera unique name'},
                           {'name': 'serial_no',                    'default': "''", 'description': 'choose device by serial number'},
                           {'name': 'usb_port_id',                  'default': "''", 'description': 'choose device by usb port id'},
                           {'name': 'device_type',                  'default': "''", 'description': 'choose device by type'},
                           {'name': 'config_file',                  'default': "''", 'description': 'yaml config file'},
                           {'name': 'unite_imu_method',             'default': '1', 'description': '[copy|linear_interpolation]'},
                           ...
                           {'name': 'rgb_camera.profile',                   'default': "'640x480x5'", 'description': 'w x h x fps'},
                           {'name': 'rgb_camera.enable_auto_exposure',      'default': 'true', 'description': 'ROI for auto exposure'},
                           {'name': 'rgb_camera.auto_exposure.roi.bottom',  'default': '659', 'description': 'ROI for auto exposure'},
                           {'name': 'rgb_camera.auto_exposure.roi.left',    'default': '0', 'description': 'ROI for auto exposure'},
                           {'name': 'rgb_camera.auto_exposure.roi.right',   'default': '479', 'description': 'ROI for auto exposure'},
                           {'name': 'rgb_camera.auto_exposure.roi.top',     'default': '0', 'description': 'ROI for auto exposure'},


                           {'name': 'depth_module.profile',                   'default': "'640x480x5'", 'description': 'w x h x fps'},
                           {'name': 'depth_module.enable_auto_exposure',      'default': 'true', 'description': 'ROI for auto exposure'},
                           {'name': 'depth_module.auto_exposure.roi.bottom',  'default': '659', 'description': 'ROI for auto exposure'},
                           {'name': 'depth_module.auto_exposure.roi.left',    'default': '0', 'description': 'ROI for auto exposure'},
                           {'name': 'depth_module.auto_exposure.roi.right',   'default': '479', 'description': 'ROI for auto exposure'},
                           {'name': 'depth_module.auto_exposure.roi.top',     'default': '0', 'description': 'ROI for auto exposure'},

                           {'name': 'align_depth.enable',                   'default': 'true', 'description': 'Align Depth'},

                           {'name': 'pointcloud.enable',                    'default': 'false', 'description': 'PointCloud'},
                          ]
...
def generate_launch_description():
    ...
    return LaunchDescription(declare_configurable_parameters(configurable_parameters) + [
        ...
        launch_ros.actions.Node(
         ...
         launch_ros.actions.Node(
             package="tf2_ros",
             name=f"realsense_tf_linker",
             executable="static_transform_publisher",
             arguments=["0", "0", "0", "0", "0", "0", f"{robot_namespace}/realsense_camera_link", f"realsense_camera_{robot_namespace}_link"])
        ])
